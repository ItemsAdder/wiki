...
<Card title="Animatedscoreboard" icon="text" href="/compatibility-with-other-plugins/compatible/animatedscoreboard"></Card>


### Plugin: Scoreboard-revision <mark>(Outdated)</mark>


<Card title="Scoreboard" icon="text" href="/compatibility-with-other-plugins/compatible/scoreboard"></Card>
