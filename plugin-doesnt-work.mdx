...
<Card title="First Install" icon="text" href="/plugin-usage/first-install" horizontal>
</Card>
...
<Card title="Identify Why Textures Are Not Shown" icon="text" href="/identify-why-textures-are-not-shown" horizontal>
</Card>
