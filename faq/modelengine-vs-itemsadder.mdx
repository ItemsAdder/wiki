...
<Card title="modelengine.md" icon="text" href="/compatibility-with-other-plugins/compatible/modelengine" horizontal>
</Card>
...
| Multiple Resource Packs                         | ✅* ([Requires merging](/plugin-usage/merge-resourcepacks))                                                                                        | ❌                                                                                                                                                                                                                                                                                     | ❌                                        |
...
<Frame>
  <iframe 
    ...
    src="https://www.youtube.com/embed/uQHvIv7-laM" 
...
<Frame>
  <iframe 
    className="w-full aspect-video rounded-xl" 
    src="https://www.youtube.com/embed/ejhiwHn2fOM" 
    title="YouTube video player" 
    frameBorder="0" 
    allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" 
    allowFullScreen 
...
<Frame>
  <iframe 
    className="w-full aspect-video rounded-xl" 
    src="https://www.youtube.com/embed/B1cxPPDNqVE?1" 
    title="YouTube video player" 
    frameBorder="0" 
    allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" 
    allowFullScreen 
...
<Frame>
  <iframe 
    className="w-full aspect-video rounded-xl" 
    src="https://www.youtube.com/embed/2zbLISIzRnA" 
    title="YouTube video player" 
    frameBorder="0" 
    allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" 
    allowFullScreen 
...
❌ IA (for now) sends <Tooltip tip="The cause is not very clear, it might be related to how ItemsAdder handles custom entities head/body orientation logic, which is close to vanilla Minecraft.">more packets</Tooltip> than MEG v3 when referring to entities walking around the world.\
