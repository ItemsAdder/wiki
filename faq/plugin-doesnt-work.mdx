...
<Card title="First Install" icon="text" href="/plugin-usage/first-install"></Card>
...
<Card title="Identify Why Textures Are Not Shown" icon="text" href="/identify-why-textures-are-not-shown"></Card>
...
<Card title="Issues" icon="link" href="https://github.com/PluginBugs/Issues-ItemsAdder/issues"></Card>
