...
<Card title="First Install" icon="text" href="/plugin-usage/first-install" horizontal></Card>
...
<Card title="Issues" icon="link" href="https://github.com/PluginBugs/Issues-ItemsAdder/issues" horizontal></Card>
