...
<Note>
Before you follow this guide, make sure you have gone through [**First Install**](/first-install) and have a working IA installation
</Note>
...
For example [**MCPACKS**](https://mc-packs.net/)**,** [**DropBox**](/../plugin-usage/resourcepack-hosting/resourcepack-on-dropbox)**,** [**GoogleDrive**](/../plugin-usage/resourcepack-hosting/google-drive)**.**
...
Read more here: [Removing default stuff](/removing-default-content)
</Warning>
