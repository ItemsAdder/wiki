...
<Card title="API ItemsAdder" icon="link" href="https://github.com/LoneDev6/API-ItemsAdder" horizontal></Card>
...
### Custom mobs <mark>(old)</mark> - [docs](https://github.com/LoneDev6/API-ItemsAdder/blob/master/src/main/java/dev/lone/itemsadder/api/CustomMob.java)
