...
<Card title="Getting Support" icon="link" href="https://forum.devs.beer/d/16-getting-support" horizontal></Card>
...
* ⛔ [Not compatible with some plugins](/compatibility-with-other-plugins/not-compatible)
</Warning>
...
Check the [FAQ](/faq) for more info.\
