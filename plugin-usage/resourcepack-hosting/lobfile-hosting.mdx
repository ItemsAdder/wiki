...
Thanks a lot to **LobFile**, which provides us their platform to host files for free!


<Card title="LobFile" icon="link" href="https://lobfile.com/" horizontal></Card>
...
It's better to use [self-host](resourcepack-self-hosting) if you're working on the resourcepack and you have to continuously run `/iazip`, to avoid losing time (read more [here](/beginners/fast-resourcepack-tips)).
