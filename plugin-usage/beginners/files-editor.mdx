...
<Card title="Download Visual Studio Code (vs-code)" icon="download" href="https://code.visualstudio.com/download" horizontal></Card>
<Card title="Download The Extension" icon="download" href="https://marketplace.visualstudio.com/items?itemName=LoneDev.ia-vscode" horizontal></Card>
