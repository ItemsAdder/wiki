...
<Card title="Modelengine" icon="text" href="/compatibility-with-other-plugins/compatible/modelengine" horizontal></Card>



<Card title="Nova" icon="text" href="/compatibility-with-other-plugins/compatible/nova" horizontal></Card>



<Card title="Space" icon="text" href="/compatibility-with-other-plugins/compatible/space" horizontal></Card>
