...
<Card title="Transparent Furniture" icon="text" href="/furniture/transparent-furniture" horizontal></Card>


### Blocks


<Card title="Transparent Block" icon="text" href="/advanced-block-properties/transparent-block" horizontal></Card>
