...
To read the list of available actions use the [official editor](/../../beginners/files-editor).
...
<img src="/assets/images/image (47).png" />
...
<mark>⚠️</mark> Make sure you didn't disable `extract_internal_utility_assets` in `config.yml`!
</Note>
...
<Note>
If you want to create a custom HUD, but you don't want to waste time coloring, you can use [this guide](/../../../other/bulk-colorize-images) to colorize images in one click.
</Note>
...
<img src="/assets/images/image (48).png" />
...
<img src="/assets/images/image (49).png" />
...
<Card title="XZLln6e3iAU" icon="link" href="https://youtu.be/xZLln6e3iAU" horizontal></Card>
