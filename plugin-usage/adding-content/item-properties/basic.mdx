...
<Card title="Permission" icon="text" href="/permission"></Card>
...
<Card title="Templates And Variants" icon="text" href="/templates-and-variants"></Card>


## Use the official files editor to read all the properties


<Card title="Files Editor" icon="text" href="/beginners/files-editor"></Card>
