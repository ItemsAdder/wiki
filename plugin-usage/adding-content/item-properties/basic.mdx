...
<Card title="Permission" icon="text" href="/plugin-usage/permission" horizontal></Card>
...
You can set [vanilla enchants](https://hub.spigotmc.org/javadocs/bukkit/org/bukkit/enchantments/Enchantment.html) and custom enchants of other plugins (for example [EcoEnchants](/../../compatibility-with-other-plugins/compatible/ecoenchants), [ExcellentEnchants](https://www.spigotmc.org/resources/goldenenchants-%E2%80%A2-more-vanilla-like-enchantments-1-14-1-16.61693/)...).\
...
Example: [magic wand example item](/other-items-examples/magic-wand).
...
<Card title="Templates And Variants" icon="text" href="/templates-and-variants" horizontal></Card>


## Use the official files editor to read all the properties


<Card title="Files Editor" icon="text" href="/beginners/files-editor" horizontal></Card>
