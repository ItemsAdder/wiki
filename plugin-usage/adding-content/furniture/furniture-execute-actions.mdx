...
You can obviously also add more [actions](/item-properties/actions/actions) to the [placed\_armorstand](/item-properties/events/) interaction event, not only `execute_commands`.
