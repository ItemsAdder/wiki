...
### Please read the [previous tutorial](frames-hud) before starting this one.

## Creating the needed configuration

The difference from [FRAMES HUDs](frames-hud) is that you don't have to bother creating one texture for each one of the possible values.
