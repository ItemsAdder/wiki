...
To make the HUD automatically increase during time you can just use [the triggers](/trigger-value-change).
...
<Card title="PlaceholderAPI" icon="text" href="plugin-usage/adding-content/font-images#placeholderapi-placeholders" horizontal>
You can read HUD values with PAPI placeholders.
</Card>
