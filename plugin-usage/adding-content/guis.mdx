...
In order to create custom GUIs you can use the [JavaAPI ](/../developers/java-api/huds-guis-images-and-more)or install a plugin like [ChestCommands](https://dev.bukkit.org/projects/chest-commands).\
...
<Card title="Hologram Guis 13 Logo Menu Graphics.21017" icon="link" href="https://builtbybit.com/resources/hologram-guis-13-logo-menu-graphics.21017/" horizontal></Card>
