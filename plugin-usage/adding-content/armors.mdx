...
For older versions tutorials read here: [simple armor](armors-old/simple-armor) or [textured armor](armors-old/textured-armor).
</Warning>
...
<img src="/assets/images/armor_textures_preview.png" />
...
<img src="/assets/images/image (239).png" />
...
<img src="/assets/images/image (238).png" />
...
To create animated or/and emissive textures you have to use [the old method shown here](armors-old/textured-armor) (uses shaders).
...
<mark>Size must be a power of 2</mark>, for example: 64x32, 128x64, 256x128, 512x256.
