...
<Warning>
If you see **bugged** textures and you have **Optifine** installed please [read here](/../../faq/armors-textures-not-working-with-shaders-mod).
</Warning>
...
For example:\
64x32, 128x64, 256x128, 512x256... <mark>it's very important! Size must be a power of 2.</mark>
</Note>
