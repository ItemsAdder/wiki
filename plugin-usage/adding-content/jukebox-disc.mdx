...
If your server accepts 1.21.1 and lower, you can follow the [old tutorial here](music-disc).
</Warning>
...
<Note>
In case you have 1.21 and lower clients you can use the old [`music_disc`](music-disc) behaviour for your items and completely avoid setting the `jukebox` property in the sound, as it's not required by the old behaviour.
</Note>
