...
You have to create a .yml file in your [namespace ](/../beginners/basic-concepts/namespace)folder \(check [other tutorials ](/../beginners/creating-your-namespace)for more info\).


<Note>
Consider using the[ official online tool](/../../../files-editor) to edit ItemsAdder files. It makes you life easier as it has autocomplete \(press CRTL+SPACE\) which helps you on avoiding mistakes.
</Note>


This is an example for a custom mob names Soul.  
As you can see I set it up like a normal item, but with a special [behaviour ](/item-properties/behaviours)named **mob**.
