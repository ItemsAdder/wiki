...
<Card title="Custom Skin" icon="text" href="/mobs/custom-skin"></Card>


## Creating custom animations


<Card title="Custom Animations" icon="text" href="/plugin-usage/adding-content/player-emotes/animations">
